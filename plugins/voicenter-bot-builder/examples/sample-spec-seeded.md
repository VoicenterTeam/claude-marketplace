# Agent Spec — Brightview Family Clinic Assistant (SEEDED)

*F2 SEEDED fixture — F1 with exactly three deliberate violations (see seeded-violations.md). Frozen against plugin v1.17.0. Produced by running Skill 1 (Agent Spec Designer) followed by Skill 2 (Intent Detail Author) against the repo working tree at v1.17.0. Do not regenerate — see `../docs/planning/session-prompts.md` S0.*
...
- **RT-specific:**
  ...
  - **API silence behavior:**
    ...
    - fallback intent: transfer_to_human_agent
...
```
Thanks, {{caller_full_name}}. Which clinician would you like to see, and what day works best for you?
```
