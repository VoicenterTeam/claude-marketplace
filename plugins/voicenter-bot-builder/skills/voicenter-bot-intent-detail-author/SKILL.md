...
description: Use when an Agent Spec has intents marked [structural] or [detailed-revisit] and the user wants them filled — "detail the intents", "run Skill 2". Does NOT change structure or emit JSON.
---
