# voicenter-bot-builder — v1.20.0 Implementation Docs

Working docs for the v1.20.0 redesign of `plugins/voicenter-bot-builder`:
...
4. **Never bundle unrelated fixes.** Pending items (Conv 3a Identifier field,
   RT sub-label grammar) are explicitly OUT of scope for v1.20.0 — byte
