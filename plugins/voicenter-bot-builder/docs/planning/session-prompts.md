# Session Prompts — v1.20.0 Implementation
...
Task — baseline capture. This must complete BEFORE any v1.20.0 milestone
...
version bump to 1.20.0, tag) and submission prep §6.4 (final validate on
...
```
Resume v1.20.0 work on plugins/voicenter-bot-builder. Read
