...
`claude plugin validate --strict` passes on `voicenter-bot-builder` as of v1.18.0, but **fails
...
This predates v1.18.0 and belongs to those plugins' own versioning — CLAUDE.md requires a
